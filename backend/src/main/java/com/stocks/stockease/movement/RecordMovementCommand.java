...
/**
 * Request to record a stock movement; {@code invoiceItemId} is accepted only for the reasons that
 * require an invoice link, {@code remark} only for {@code LOST} and {@code DESTROYED}, which require
 * it, and {@code unitCost} by no reason at all - a purchase snapshots it from its invoice line.
 *
