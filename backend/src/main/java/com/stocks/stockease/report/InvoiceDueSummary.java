 ...
 * @param invoiceNumber operator-assigned business identifier
 ...
 */
public record InvoiceDueSummary(Long invoiceId, String invoiceNumber, String invoiceType, String counterparty,
        LocalDate dueDate, BigDecimal outstandingValue, Long daysOverdue) {
}
