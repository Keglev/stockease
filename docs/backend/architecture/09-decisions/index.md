...
- [ADR 002 - Validation Strategy](002-validation-strategy.md)
- [ADR 003 - Authentication Mechanism](003-authentication-mechanism.md)
- [ADR 004 - Inventory Domain Model](004-inventory-domain-model.md)
- [ADR 006 - Audit and Profit Model](006-audit-and-profit-model.md)
- [ADR 007 - Modular Monolith with Spring Modulith](007-modular-monolith.md)
- [ADR 008 - Documentation Structure](008-documentation-structure.md)
