...
- **[Architecture site](https://keglev.github.io/stockease/)** - arc42 documentation for both tiers, module reference, and 37 Architecture Decision Records. Backend entry pages are bilingual EN/DE.
